...
import PopUpNotification from "../components/others/PopUpNotification.jsx"; // adjust path if needed
...
const SignIn = () => {
  ...
  useEffect(() => {
    if (actionData?.user) {
      ...
      setTimeout(() => navigate("/"), 2000); // Delay to show popup
    } else if (actionData?.general) {
      setPopup({
        show: true,
        message: actionData.general,
        isSuccess: false,
      });
    }
